...
#    Updated: 2022/06/13 19:00:03 by wding-ha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
S_BIN			= $(BIN_DIR)bin_export.c $(BIN_DIR)bin_echo.c $(BIN_DIR)bin_env.c $(BIN_DIR)bin_unset.c $(BIN_DIR)bin_exit.c $(BIN_DIR)bin_pwd.c $(BIN_DIR)bin_cd.c
